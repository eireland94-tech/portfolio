...
> **This page is the full manual, rendered.** It is long on purpose - it is
...
### <a id="001--search-tags"></a>00.1 — Search tags
...
### <a id="003--maintenance-protocol-how-to-add-to-this-manual"></a>00.3 — Maintenance protocol (how to add to this manual)
...
## <a id="01--troubleshooting-doctrine-doctrine"></a>01 — TROUBLESHOOTING DOCTRINE `[DOCTRINE]`
...
### <a id="doctrine-01-confirm-the-component-is-in-the-path-before-you-troubleshoot-it"></a>`[DOCTRINE-01]` Confirm the component is in the path before you troubleshoot it
...
### <a id="doctrine-02-read-the-error-text-before-forming-a-theory"></a>`[DOCTRINE-02]` Read the error text before forming a theory
...
### <a id="doctrine-03-know-a-diagnostics-precondition-before-you-run-it"></a>`[DOCTRINE-03]` Know a diagnostic's precondition before you run it
...
### <a id="doctrine-04-the-error-message-describes-the-symptom-not-the-cause"></a>`[DOCTRINE-04]` The error message describes the symptom, not the cause
...
### <a id="doctrine-05-a-workaround-is-a-change-to-the-environment-write-it-down"></a>`[DOCTRINE-05]` A workaround is a change to the environment. Write it down.
...
### <a id="doctrine-06-verify-negatively-not-just-positively"></a>`[DOCTRINE-06]` Verify negatively, not just positively
...
### <a id="doctrine-07-a-backup-you-have-never-restored-from-is-a-hypothesis"></a>`[DOCTRINE-07]` A backup you have never restored from is a hypothesis
...
### <a id="doctrine-08-on-an-inherited-system-document-first-change-second-one-thing-at-a-time"></a>`[DOCTRINE-08]` On an inherited system: document first, change second, one thing at a time
...
### <a id="doctrine-09-build-foundation-before-there-are-users-to-disturb"></a>`[DOCTRINE-09]` Build foundation before there are users to disturb
...
### <a id="doctrine-10-escalate-on-cost-of-being-wrong-not-on-difficulty"></a>`[DOCTRINE-10]` Escalate on cost of being wrong, not on difficulty
...
### <a id="doctrine-11-an-override-makes-your-diagnostics-lie"></a>`[DOCTRINE-11]` An override makes your diagnostics lie
...
### <a id="doctrine-12-read-the-screen-before-you-diagnose"></a>`[DOCTRINE-12]` Read the screen before you diagnose
...
## <a id="02--powershell-fundamentals-ps"></a>02 — POWERSHELL FUNDAMENTALS `[PS]`

### <a id="ps-01-discovery--the-four-commands-that-make-the-rest-unnecessary"></a>`[PS-01]` Discovery — the four commands that make the rest unnecessary
...
### <a id="ps-02-pipeline-and-filtering"></a>`[PS-02]` Pipeline and filtering
...
### <a id="ps-03-output-and-export"></a>`[PS-03]` Output and export
...
### <a id="ps-04-variables-logic-loops"></a>`[PS-04]` Variables, logic, loops
...
### <a id="ps-05-operators-and-common-parameters"></a>`[PS-05]` Operators and common parameters
...
### <a id="ps-06-execution-policy-ps-exec"></a>`[PS-06]` Execution policy `[PS-EXEC]`
...
### <a id="ps-07-safe-script-header-template"></a>`[PS-07]` Safe-script header template
...
### <a id="ps-08-bulk-operation-safety-pattern-ps-bulk"></a>`[PS-08]` Bulk operation safety pattern `[PS-BULK]`
...
### <a id="ps-09-splatting--kills-the-backtick-problem-permanently"></a>`[PS-09]` Splatting — kills the backtick problem permanently
...
### <a id="ps-10-idempotence--write-scripts-that-survive-a-partial-run"></a>`[PS-10]` Idempotence — write scripts that survive a partial run
...
### <a id="ps-11-powershell-51-vs-powershell-7--what-actually-differs-in-the-field"></a>`[PS-11]` PowerShell 5.1 vs PowerShell 7 — what actually differs in the field
...
## <a id="03--cmd--powershell-equivalents-ps-cmd"></a>03 — CMD ↔ POWERSHELL EQUIVALENTS `[PS-CMD]`
...
### <a id="win-inv-installed-software-inventory-that-actually-works"></a>`[WIN-INV]` Installed-software inventory that actually works
...
## <a id="04--network-diagnostics-net"></a>04 — NETWORK DIAGNOSTICS `[NET]`
...
### <a id="net-01-test-netconnection--the-single-most-useful-networking-cmdlet-on-windows"></a>`[NET-01]` `Test-NetConnection` — the single most useful networking cmdlet on Windows
...
### <a id="net-02-multi-port-scan-loop-no-modules-required-ps-51"></a>`[NET-02]` Multi-port scan loop (no modules required, PS 5.1+)
...
### <a id="net-03-psnmap--subnet-and-port-range-scanning"></a>`[NET-03]` PSnmap — subnet and port-range scanning
...
### <a id="net-04-traceroute-three-ways"></a>`[NET-04]` Traceroute, three ways
...
### <a id="net-05-dns-troubleshooting"></a>`[NET-05]` DNS troubleshooting
...
### <a id="net-06-standard-connectivity-triage-net-triage"></a>`[NET-06]` Standard connectivity triage `[NET-TRIAGE]`
...
### <a id="net-07-combined-port-scan--traceroute-script"></a>`[NET-07]` Combined port scan + traceroute script
...
### <a id="net-08-port-reference--infrastructure"></a>`[NET-08]` Port reference — infrastructure
...
### <a id="net-10-dhcp-option-reference--the-two-that-matter-for-ad"></a>`[NET-10]` DHCP option reference — the two that matter for AD
...
### <a id="net-11-dhcp-relay--ip-helper"></a>`[NET-11]` DHCP relay / IP helper
...
## <a id="05--active-directory-operations-ad"></a>05 — ACTIVE DIRECTORY OPERATIONS `[AD]`

### <a id="ad-00-load-the-module-and-confirm-you-can-reach-a-dc"></a>`[AD-00]` Load the module and confirm you can reach a DC
...
### <a id="ad-rsat-build-a-management-workstation--stop-administering-from-the-dc"></a>`[AD-RSAT]` Build a management workstation — stop administering from the DC
...
### <a id="ad-01-user-lookup"></a>`[AD-01]` User lookup
...
### <a id="ad-02-user-account-actions"></a>`[AD-02]` User account actions
...
### <a id="ad-03-group-management"></a>`[AD-03]` Group management
...
### <a id="ad-04-computer-objects-and-ous"></a>`[AD-04]` Computer objects and OUs
...
### <a id="ad-05-account-discovery-and-hygiene"></a>`[AD-05]` Account discovery and hygiene
...
### <a id="ad-06-health-and-infrastructure-checks-ad-health"></a>`[AD-06]` Health and infrastructure checks `[AD-HEALTH]`
...
### <a id="ad-07-time-configuration--a-foundation-item-not-an-afterthought-ad-time"></a>`[AD-07]` Time configuration — a foundation item, not an afterthought `[AD-TIME]`
...
### <a id="ad-08-the-agdlp-group-model-ad-agdlp"></a>`[AD-08]` The AGDLP group model `[AD-AGDLP]`
...
### <a id="ad-09-upn-suffix-management-ad-upn"></a>`[AD-09]` UPN suffix management `[AD-UPN]`
...
### <a id="ad-10-bulk-user-creation-with-unique-passwords"></a>`[AD-10]` Bulk user creation with unique passwords
...
### <a id="ad-11-fsmo-roles--what-they-are-and-what-breaks"></a>`[AD-11]` FSMO roles — what they are and what breaks
...
### <a id="ad-12-ad-recycle-bin"></a>`[AD-12]` AD Recycle Bin
...
### <a id="ad-13-system-state-backup"></a>`[AD-13]` System State backup
...
### <a id="ad-14-windows-laps-sec-laps"></a>`[AD-14]` Windows LAPS `[SEC-LAPS]`
...
### <a id="ad-15-account-lockout-triage--the-source-matters-more-than-the-unlock-ad-lockout"></a>`[AD-15]` Account lockout triage — the source matters more than the unlock `[AD-LOCKOUT]`
...
## <a id="06--greenfield-build-order-ad-build"></a>06 — GREENFIELD BUILD ORDER `[AD-BUILD]`
...
### <a id="phase-0--design-decisions-build-p0"></a>PHASE 0 — Design decisions `[BUILD-P0]`

Do this on paper before touching hardware.

#### <a id="01-domain-name"></a>0.1 Domain name
...
#### <a id="02-naming-conventions"></a>0.2 Naming conventions
...
#### <a id="03-addressing-plan"></a>0.3 Addressing plan
...
#### <a id="04-cloud-tenant"></a>0.4 Cloud tenant
...
#### <a id="05-licensing-prerequisites"></a>0.5 Licensing prerequisites
...
#### <a id="06-public-dns-and-mail--decide-before-you-build"></a>0.6 Public DNS and mail — decide before you build
...
#### <a id="07-credential-handling"></a>0.7 Credential handling
...
### <a id="phase-1--server-base-build-build-p1"></a>PHASE 1 — Server base build `[BUILD-P1]`
...
### <a id="phase-2--first-domain-controller-dns-time-build-p2"></a>PHASE 2 — First domain controller, DNS, time `[BUILD-P2]`

#### <a id="21-promotion"></a>2.1 Promotion
...
#### <a id="22-dns-hygiene--immediately-after-reboot"></a>2.2 DNS hygiene — immediately after reboot
...
### <a id="phase-3--backup-and-ad-recycle-bin-build-p3"></a>PHASE 3 — Backup and AD Recycle Bin `[BUILD-P3]`

Do this **before creating a single object**. See `[AD-12]` and `[AD-13]`.

---

### <a id="phase-4--dhcp-and-client-dns-delivery-build-p4"></a>PHASE 4 — DHCP and client DNS delivery `[BUILD-P4]`
...
### <a id="phase-5--ou-structure-and-container-redirection-build-p5"></a>PHASE 5 — OU structure and container redirection `[BUILD-P5]`
...
#### <a id="52-redirect-the-default-containers--the-one-command-nobody-runs"></a>5.2 Redirect the default containers — the one command nobody runs
...
### <a id="phase-6--security-groups-build-p6"></a>PHASE 6 — Security groups `[BUILD-P6]`

See `[AD-AGDLP]`. Build both tiers before any user or any permission exists.

---

### <a id="phase-7--file-services-build-p7"></a>PHASE 7 — File services `[BUILD-P7]`

See `[FILE]` — Section 08.

---

### <a id="phase-8--group-policy-build-p8"></a>PHASE 8 — Group Policy `[BUILD-P8]`

See `[GPO]` — Section 07.

---

### <a id="phase-9--cloud-identity-before-creating-users-build-p9"></a>PHASE 9 — Cloud identity, before creating users `[BUILD-P9]`
...
### <a id="phase-10--create-users-build-p10"></a>PHASE 10 — Create users `[BUILD-P10]`

See `[AD-10]`. Script it from the first user, not the tenth. **The script is the documentation.**

---

### <a id="phase-11--build-and-join-workstations-build-p11"></a>PHASE 11 — Build and join workstations `[BUILD-P11]`

See `[WIN]` — Section 13.

---

### <a id="phase-12--intune-policy-and-applications-build-p12"></a>PHASE 12 — Intune policy and applications `[BUILD-P12]`

See `[MDM]` — Section 10.

---

### <a id="phase-13--second-dc-and-real-redundancy-build-p13-ad-failover"></a>PHASE 13 — Second DC and real redundancy `[BUILD-P13]` `[AD-FAILOVER]`

Adding DC02 is the easy part. **Making the environment actually fail over is the part that gets skipped.**

#### <a id="131-build-dc02"></a>13.1 Build DC02
...
#### <a id="132-wire-up-the-redundancy--the-part-that-is-usually-missed"></a>13.2 Wire up the redundancy — the part that is usually missed
...
#### <a id="133-how-to-test-failover-correctly"></a>13.3 How to test failover correctly
...
### <a id="phase-135--azure-arc-optional-az-arc"></a>PHASE 13.5 — Azure Arc (optional) `[AZ-ARC]`
...
### <a id="phase-14--operations-and-handover-build-p14"></a>PHASE 14 — Operations and handover `[BUILD-P14]`
...
## <a id="07--group-policy-gpo"></a>07 — GROUP POLICY `[GPO]`

### <a id="gpo-01-the-rule-that-trips-everyone"></a>`[GPO-01]` The rule that trips everyone
...
### <a id="gpo-02-ground-rules"></a>`[GPO-02]` Ground rules
...
### <a id="gpo-03-order-of-precedence"></a>`[GPO-03]` Order of precedence
...
### <a id="gpo-04-gpos-to-build-in-a-standard-smb-environment"></a>`[GPO-04]` GPOs to build in a standard SMB environment

#### <a id="a-default-domain-policy--passwords-and-lockout"></a>A. Default Domain Policy — passwords and lockout
```
...
#### <a id="b-workstations---baseline-security--linked-to-ouworkstations"></a>B. `Workstations - Baseline Security` → linked to `OU=Workstations`
```
Computer Configuration > Policies > Windows Settings > Security Settings
...
#### <a id="c-workstations---laps--linked-to-ouworkstations"></a>C. `Workstations - LAPS` → linked to `OU=Workstations`
See `[SEC-LAPS]`.

#### <a id="d-workstations---mdm-auto-enrollment--linked-to-ouworkstations"></a>D. `Workstations - MDM Auto-Enrollment` → linked to `OU=Workstations`
```
...
#### <a id="e-employees---drive-maps--linked-to-ouemployees"></a>E. `Employees - Drive Maps` → linked to `OU=Employees`
```
...
#### <a id="gpo-drivemap-drive-maps-action-reference--the-one-that-causes-hangs"></a>`[GPO-DRIVEMAP]` Drive Maps action reference — the one that causes hangs
...
#### <a id="f-employees---folder-redirection--linked-to-ouemployees"></a>F. `Employees - Folder Redirection` → linked to `OU=Employees`
```
...
#### <a id="g-workstations---remote-access--linked-to-ouworkstations-optional"></a>G. `Workstations - Remote Access` → linked to `OU=Workstations` (optional)
```
...
### <a id="gpo-05-group-policy-troubleshooting-gpo-triage"></a>`[GPO-05]` Group Policy troubleshooting `[GPO-TRIAGE]`
...
### <a id="gpo-06-group-policy-vs-intune--decide-who-owns-what-in-writing"></a>`[GPO-06]` Group Policy vs Intune — decide who owns what, in writing
...
## <a id="08--file-services-and-permissions-file"></a>08 — FILE SERVICES AND PERMISSIONS `[FILE]`

### <a id="file-01-folder-layout"></a>`[FILE-01]` Folder layout
...
### <a id="file-02-the-standard-permission-model--the-one-that-saves-you"></a>`[FILE-02]` The standard permission model — the one that saves you
...
### <a id="file-03-create-shares--idempotent-version"></a>`[FILE-03]` Create shares — idempotent version
...
### <a id="file-04-access-based-enumeration-abe"></a>`[FILE-04]` Access-Based Enumeration (ABE)
...
### <a id="file-05-ntfs-permissions-on-a-department-folder"></a>`[FILE-05]` NTFS permissions on a department folder
...
### <a id="file-06-home-and-redirected-root-permissions--exact-values"></a>`[FILE-06]` Home and Redirected root permissions — exact values
...
### <a id="file-502-folder-redirection-event-id-502-access-is-denied--the-fix-nobody-finds"></a>`[FILE-502]` Folder Redirection Event ID 502, "Access is denied" — the fix nobody finds
...
### <a id="file-07-unc-paths-server-name-vs-dfs-namespace"></a>`[FILE-07]` UNC paths: server name vs DFS Namespace
...
### <a id="file-08-i-cant-get-to-the-file-share--triage-file-triage"></a>`[FILE-08]` "I can't get to the file share" — triage `[FILE-TRIAGE]`
...
### <a id="file-09-take-ownership-and-rebuild-after-a-lockout"></a>`[FILE-09]` Take ownership and rebuild after a lockout
...
## <a id="09--hybrid-identity-hyb"></a>09 — HYBRID IDENTITY `[HYB]`

### <a id="hyb-00--updated--product-names-and-what-actually-exists"></a>`[HYB-00]` 🔄 UPDATED — product names and what actually exists
...
### <a id="hyb-01-connect-sync-or-cloud-sync-the-choice-is-determined-not-preferred"></a>`[HYB-01]` Connect Sync or Cloud Sync? The choice is determined, not preferred
...
### <a id="hyb-02-install-entra-connect-sync"></a>`[HYB-02]` Install Entra Connect Sync
...
### <a id="hyb-03--stop--verify-the-scp-before-going-any-further-hyb-scp"></a>`[HYB-03]` 🛑 STOP — verify the SCP before going any further `[HYB-SCP]`
...
### <a id="hyb-04-running-sync-cycles-hyb-sync"></a>`[HYB-04]` Running sync cycles `[HYB-SYNC]`
...
### <a id="hyb-05-adsync-module-wont-load"></a>`[HYB-05]` ADSync module won't load
...
### <a id="hyb-06-diagnostics-and-logs"></a>`[HYB-06]` Diagnostics and logs
...
### <a id="hyb-07-group-based-licensing--three-steps-all-required-hyb-lic"></a>`[HYB-07]` Group-based licensing — three steps, all required `[HYB-LIC]`
...
### <a id="hyb-08-hybrid-join-sequence-and-expected-delays-hyb-join"></a>`[HYB-08]` Hybrid join sequence and expected delays `[HYB-JOIN]`
...
### <a id="hyb-09-reading-the-dsregcmd-status-diagnostic-data-block"></a>`[HYB-09]` Reading the `dsregcmd /status` Diagnostic Data block
...
### <a id="hyb-10-entra-dynamic-device-groups--create-these-early"></a>`[HYB-10]` Entra dynamic device groups — create these early
...
## <a id="10--intune-and-device-management-mdm"></a>10 — INTUNE AND DEVICE MANAGEMENT `[MDM]`

### <a id="mdm-01-build-order"></a>`[MDM-01]` Build order
...
### <a id="mdm-ownership--device-ownership--the-most-instructive-failure-in-hybrid-work"></a>`[MDM-OWNERSHIP]` 🛑 Device ownership — the most instructive failure in hybrid work
...
### <a id="mdm-02-know-which-delivery-mechanism-you-are-troubleshooting"></a>`[MDM-02]` Know which delivery mechanism you are troubleshooting
...
### <a id="mdm-03-verify-an-app-deployment-from-the-client-not-the-portal"></a>`[MDM-03]` Verify an app deployment from the client, not the portal
...
### <a id="mdm-04-when-an-assignment-appears-to-do-nothing"></a>`[MDM-04]` When an assignment appears to do nothing
...
### <a id="mdm-05-device-sync-from-the-client--three-routes"></a>`[MDM-05]` Device sync from the client — three routes
...
### <a id="mdm-06-retire-vs-wipe"></a>`[MDM-06]` Retire vs Wipe
...
### <a id="mdm-07-device-not-compliant--checklist"></a>`[MDM-07]` Device not compliant — checklist
...
### <a id="mdm-08-enrollment-failure--checklist"></a>`[MDM-08]` Enrollment failure — checklist
...
### <a id="mdm-09-bitlocker-recovery"></a>`[MDM-09]` BitLocker recovery
...
## <a id="11--microsoft-365-administration-m365"></a>11 — MICROSOFT 365 ADMINISTRATION `[M365]`

### <a id="m365-00-admin-portals"></a>`[M365-00]` Admin portals
...
### <a id="m365-01-microsoft-graph-powershell--the-current-standard"></a>`[M365-01]` Microsoft Graph PowerShell — the current standard
...
### <a id="m365-02-exchange-online-powershell"></a>`[M365-02]` Exchange Online PowerShell
...
### <a id="m365-03-sharepoint-online--onedrive-powershell"></a>`[M365-03]` SharePoint Online / OneDrive PowerShell
...
### <a id="m365-04-new-user-provisioning-checklist-sop-onboard-m365"></a>`[M365-04]` New user provisioning checklist `[SOP-ONBOARD-M365]`
...
### <a id="m365-05-licensing-notes"></a>`[M365-05]` Licensing notes
...
### <a id="m365-06-entra-id-core-concepts"></a>`[M365-06]` Entra ID core concepts
...
### <a id="m365-07-sign-in-troubleshooting--cloud"></a>`[M365-07]` Sign-in troubleshooting — cloud
...
### <a id="m365-08-which-admin-center--task-to-portal-decision-table"></a>`[M365-08]` Which admin center — task-to-portal decision table
...
### <a id="m365-09-exchange-recipient-objects--pick-the-right-one"></a>`[M365-09]` Exchange recipient objects — pick the right one
...
### <a id="m365-10-entra-and-microsoft-365-group-types--the-security-object-decision-table"></a>`[M365-10]` Entra and Microsoft 365 group types — the security-object decision table
...
### <a id="m365-11-sharepoint-objects-roles-and-permission-inheritance"></a>`[M365-11]` SharePoint objects, roles, and permission inheritance
...
### <a id="m365-12-teams-policies"></a>`[M365-12]` Teams policies
...
### <a id="m365-13-licensing-mechanics--service-plans-usage-location-group-licensing-limits"></a>`[M365-13]` Licensing mechanics — service plans, usage location, group licensing limits
...
### <a id="m365-14-conditional-access--anatomy-safe-rollout-and-the-two-things-that-lock-you-out"></a>`[M365-14]` Conditional Access — anatomy, safe rollout, and the two things that lock you out
...
### <a id="m365-15-privileged-identity-management--eliminating-standing-access"></a>`[M365-15]` Privileged Identity Management — eliminating standing access
...
### <a id="m365-16-app-registrations-vs-enterprise-applications"></a>`[M365-16]` App registrations vs enterprise applications
...
### <a id="m365-17-three-scores-three-scopes--do-not-mix-them-up"></a>`[M365-17]` Three scores, three scopes — do not mix them up
...
### <a id="m365-18-the-unified-audit-log--who-did-what-to-which-content"></a>`[M365-18]` The unified audit log — who did what to which content
...
### <a id="m365-19-authentication-methods-ranked-and-the-three-hybrid-models"></a>`[M365-19]` Authentication methods, ranked, and the three hybrid models
...
### <a id="m365-20-defender-xdr-and-the-threat-protection-features-worth-naming"></a>`[M365-20]` Defender XDR and the threat-protection features worth naming
...
### <a id="az-01-cloud-service-models-and-shared-responsibility"></a>`[AZ-01]` Cloud service models and shared responsibility
...
### <a id="az-02-deployment-models"></a>`[AZ-02]` Deployment models
...
### <a id="az-03-cost-models--capex-vs-opex-and-pricing-options"></a>`[AZ-03]` Cost models — CapEx vs OpEx and pricing options
...
### <a id="az-04-architecture--physical-and-management-hierarchy"></a>`[AZ-04]` Architecture — physical and management hierarchy
...
### <a id="az-05-compute"></a>`[AZ-05]` Compute
...
### <a id="az-06-networking"></a>`[AZ-06]` Networking
...
### <a id="az-07-storage"></a>`[AZ-07]` Storage
...
### <a id="az-08-identity-access-and-security"></a>`[AZ-08]` Identity, access, and security
...
### <a id="az-rbac-vs-entra--entra-roles-and-azure-rbac-are-two-different-systems"></a>`[AZ-RBAC-VS-ENTRA]` 🛑 Entra roles and Azure RBAC are two different systems
...
### <a id="az-09-governance-and-management-tools"></a>`[AZ-09]` Governance and management tools
...
### <a id="az-10-monitoring--four-tools-three-questions"></a>`[AZ-10]` Monitoring — four tools, three questions
...
### <a id="az-11-numbers-worth-knowing"></a>`[AZ-11]` Numbers worth knowing
...
## <a id="13--windows-client-build-and-domain-join-win"></a>13 — WINDOWS CLIENT BUILD AND DOMAIN JOIN `[WIN]`

### <a id="win-01-media-preparation"></a>`[WIN-01]` Media preparation
...
### <a id="win-oobe--updated--creating-a-local-account-at-oobe"></a>`[WIN-OOBE]` 🔄 UPDATED — creating a local account at OOBE
...
### <a id="win-02-client-build-sequence"></a>`[WIN-02]` Client build sequence
...
### <a id="win-prejoin-pre-join-verification--run-all-four-in-order"></a>`[WIN-PREJOIN]` Pre-join verification — run all four, in order
...
### <a id="ad-join-fail--an-active-directory-domain-controller-could-not-be-contacted--decode-it"></a>`[AD-JOIN-FAIL]` 🛑 "An Active Directory Domain Controller could not be contacted" — decode it
...
### <a id="win-03--step-8-determines-device-ownership-permanently"></a>`[WIN-03]` 🛑 Step 8 determines device ownership permanently
...
### <a id="win-postjoin-standard-post-join-verification"></a>`[WIN-POSTJOIN]` Standard post-join verification
...
### <a id="win-04-broken-machine-account-trust"></a>`[WIN-04]` Broken machine account trust
...
### <a id="win-05-hyper-v-notes-for-lab-and-dc02-builds"></a>`[WIN-05]` Hyper-V notes for lab and DC02 builds
...
### <a id="win-06-windows-update-and-application-troubleshooting"></a>`[WIN-06]` Windows update and application troubleshooting
...
### <a id="win-07-printer-troubleshooting"></a>`[WIN-07]` Printer troubleshooting
...
### <a id="disk-01-inspecting-disks"></a>`[DISK-01]` Inspecting disks
...
### <a id="disk-02-reformatting-a-drive-after-bitlocker-partition-deletion"></a>`[DISK-02]` Reformatting a drive after BitLocker partition deletion
...
#### <a id="option-1--disk-management-gui-simple-case"></a>Option 1 — Disk Management GUI (simple case)
...
#### <a id="option-2--diskpart-full-wipe"></a>Option 2 — Diskpart (full wipe)
...
### <a id="disk-03-bitlocker-operations"></a>`[DISK-03]` BitLocker operations
...
## <a id="15--standard-operating-procedures-sop"></a>15 — STANDARD OPERATING PROCEDURES `[SOP]`

Written so someone else could run them — **which is the actual test of whether a procedure is documented or just remembered.**

### <a id="sop-01-new-user-onboarding"></a>`[SOP-01]` New user onboarding
...
### <a id="sop-02-user-offboarding"></a>`[SOP-02]` User offboarding
...
### <a id="sop-03-workstation-deployment"></a>`[SOP-03]` Workstation deployment
...
### <a id="sop-04-new-file-share-or-permission-change"></a>`[SOP-04]` New file share or permission change
...
### <a id="sop-05-add-a-domain-controller"></a>`[SOP-05]` Add a domain controller
...
### <a id="sop-06-monthly-maintenance-check"></a>`[SOP-06]` Monthly maintenance check
...
### <a id="sop-07-domain-controller-failure-and-fsmo-seizure"></a>`[SOP-07]` Domain controller failure and FSMO seizure
...
### <a id="sop-08-account-lockout-triage"></a>`[SOP-08]` Account lockout triage

See `[AD-LOCKOUT]`. **Find the source before you unlock.**

### <a id="sop-09-suspected-compromised-account-sec-ir"></a>`[SOP-09]` Suspected compromised account `[SEC-IR]`
...
### <a id="sop-10-suspicious-email--phishing"></a>`[SOP-10]` Suspicious email / phishing
...
### <a id="sop-11-remote-support-session"></a>`[SOP-11]` Remote support session
...
### <a id="sop-12-daily-msp-rhythm"></a>`[SOP-12]` Daily MSP rhythm
...
## <a id="16--assessing-an-inherited-network-assess"></a>16 — ASSESSING AN INHERITED NETWORK `[ASSESS]`
...
### <a id="assess-01-discovery-block--run-this-before-touching-anything"></a>`[ASSESS-01]` Discovery block — run this before touching anything
...
### <a id="assess-02-what-you-will-actually-find--prioritized-by-risk-not-by-ease"></a>`[ASSESS-02]` What you will actually find — prioritized by risk, not by ease
...
### <a id="assess-03-triage-decision-trees"></a>`[ASSESS-03]` Triage decision trees

#### <a id="i-cant-log-in"></a>"I can't log in"
...
#### <a id="i-cant-get-to-the-file-share"></a>"I can't get to the file share"
See `[FILE-TRIAGE]`.

#### <a id="group-policy-isnt-applying"></a>"Group Policy isn't applying"
See `[GPO-TRIAGE]`.

#### <a id="the-device-isnt-showing-up-in-intune"></a>"The device isn't showing up in Intune"
...
## <a id="17--decommissioning-a-hybrid-environment-decom"></a>17 — DECOMMISSIONING A HYBRID ENVIRONMENT `[DECOM]`
...
### <a id="decom-00--the-one-rule-that-governs-the-whole-sequence"></a>`[DECOM-00]` 🛑 The one rule that governs the whole sequence
...
### <a id="decom-p0-phase-0--stop-the-financial-clock-do-this-first-today"></a>`[DECOM-P0]` Phase 0 — Stop the financial clock (do this first, today)
...
### <a id="decom-p1-phase-1--capture-the-before-state"></a>`[DECOM-P1]` Phase 1 — Capture the "before" state
...
### <a id="decom-p2-phase-2--application-and-policy-layer-intune"></a>`[DECOM-P2]` Phase 2 — Application and policy layer (Intune)
...
### <a id="decom-p3-phase-3--device-identity-entra"></a>`[DECOM-P3]` Phase 3 — Device identity (Entra)
...
### <a id="decom-p4-phase-4--user-and-group-identity-via-sync-the-critical-phase"></a>`[DECOM-P4]` Phase 4 — User and group identity via sync (the critical phase)
...
### <a id="decom-p5-phase-5--remove-hybrid-join-configuration-from-ad"></a>`[DECOM-P5]` Phase 5 — Remove hybrid join configuration from AD
...
### <a id="decom-p6-phase-6--uninstall-entra-connect"></a>`[DECOM-P6]` Phase 6 — Uninstall Entra Connect
...
### <a id="decom-p7-phase-7--disable-directory-synchronization-in-the-tenant"></a>`[DECOM-P7]` Phase 7 — Disable directory synchronization in the tenant
...
### <a id="decom-p8-phase-8--purge-entra"></a>`[DECOM-P8]` Phase 8 — Purge Entra
...
### <a id="decom-p9-phase-9--azure-decommission"></a>`[DECOM-P9]` Phase 9 — Azure decommission
...
### <a id="decom-p10-phase-10--on-premises-teardown"></a>`[DECOM-P10]` Phase 10 — On-premises teardown
...
### <a id="decom-p11-phase-11--cancel-the-subscription-last"></a>`[DECOM-P11]` Phase 11 — Cancel the subscription (last)
...
### <a id="decom-p12-post-decommission-writeup"></a>`[DECOM-P12]` Post-decommission writeup
...
## <a id="18--error--cause--fix-master-index-err"></a>18 — ERROR → CAUSE → FIX MASTER INDEX `[ERR]`

**Search this table first.** Every row is a real failure traced to its actual cause.

### <a id="domain-join-and-authentication"></a>Domain join and authentication
...
### <a id="group-policy"></a>Group Policy
...
### <a id="files-and-permissions"></a>Files and permissions
...
### <a id="hybrid-identity"></a>Hybrid identity
...
### <a id="azure-and-cloud"></a>Azure and cloud
...
### <a id="powershell-and-scripting"></a>PowerShell and scripting
...
### <a id="networking-and-infrastructure"></a>Networking and infrastructure
...
### <a id="windows-client"></a>Windows client
...
### <a id="purview-and-copilot"></a>Purview and Copilot
...
### <a id="public-dns-and-mail-flow"></a>Public DNS and mail flow
...
### <a id="exchange-online"></a>Exchange Online
...
### <a id="sharepoint-online-onedrive-and-external-sharing"></a>SharePoint Online, OneDrive, and external sharing
...
### <a id="purview--labels-and-dlp"></a>Purview — labels and DLP
| Symptom | Actual cause | Fix |
|---|---|---|
...
## <a id="19--script-library-and-toolkit-pattern-toolkit"></a>19 — SCRIPT LIBRARY AND TOOLKIT PATTERN `[TOOLKIT]`
...
### <a id="toolkit-01-directory-layout"></a>`[TOOLKIT-01]` Directory layout
...
### <a id="toolkit-02-the-client-config-file"></a>`[TOOLKIT-02]` The client config file
...
### <a id="toolkit-03-a-parameterised-script"></a>`[TOOLKIT-03]` A parameterised script
...
### <a id="toolkit-04-why-each-piece-is-there"></a>`[TOOLKIT-04]` Why each piece is there
...
### <a id="toolkit-05-getting-them-to-run"></a>`[TOOLKIT-05]` Getting them to run
...
### <a id="toolkit-06-build-order-for-your-own-toolkit"></a>`[TOOLKIT-06]` Build order for your own toolkit
...
### <a id="toolkit-07-useful-script-categories-to-build-over-time"></a>`[TOOLKIT-07]` Useful script categories to build over time
...
## <a id="20--documentation-templates-doc"></a>20 — DOCUMENTATION TEMPLATES `[DOC]`

### <a id="doc-01-ticket"></a>`[DOC-01]` Ticket
...
### <a id="doc-02-escalation"></a>`[DOC-02]` Escalation
...
### <a id="doc-03-knowledge-base-entry"></a>`[DOC-03]` Knowledge base entry
...
### <a id="doc-04-personal-lessons-learned-entry"></a>`[DOC-04]` Personal lessons-learned entry
...
### <a id="doc-05-client-handover-package--the-deliverables-list"></a>`[DOC-05]` Client handover package — the deliverables list
...
## <a id="21--appendices"></a>21 — APPENDICES

### <a id="apx-a-pre-flight-checklists"></a>`[APX-A]` Pre-flight checklists
...
### <a id="apx-b-least-privilege-reminders-sec-lp"></a>`[APX-B]` Least privilege reminders `[SEC-LP]`
...
### <a id="apx-c-corrections-applied-when-this-manual-was-compiled"></a>`[APX-C]` Corrections applied when this manual was compiled
...
### <a id="apx-e-learning-roadmap"></a>`[APX-E]` Learning roadmap
...
### <a id="apx-f-disambiguation-index--the-pairs-that-get-confused"></a>`[APX-F]` Disambiguation index — the pairs that get confused
...
### <a id="apx-g-requirement--tool-index"></a>`[APX-G]` Requirement → tool index
...
### <a id="apx-h-hard-limits-defaults-and-thresholds"></a>`[APX-H]` Hard limits, defaults, and thresholds
...
## <a id="22--networking-fundamentals-netf"></a>22 — NETWORKING FUNDAMENTALS `[NETF]`
...
### <a id="netf-01-the-layered-model--and-how-to-actually-use-it"></a>`[NETF-01]` The layered model — and how to actually use it
...
### <a id="netf-02-encapsulation--why-a-packet-is-four-different-things"></a>`[NETF-02]` Encapsulation — why a "packet" is four different things
...
### <a id="netf-03-layer-1--physical-media-and-link-diagnosis"></a>`[NETF-03]` Layer 1 — physical media and link diagnosis
...
#### <a id="reading-an-rj45-port-without-any-software"></a>Reading an RJ45 port without any software
...
### <a id="netf-04-layer-2--ethernet-mac-arp-vlans"></a>`[NETF-04]` Layer 2 — Ethernet, MAC, ARP, VLANs

#### <a id="the-ethernet-frame"></a>The Ethernet frame
...
#### <a id="mac-addresses"></a>MAC addresses
...
#### <a id="arp--address-resolution-protocol"></a>ARP — Address Resolution Protocol
...
### <a id="netf-05-layer-3--the-ip-datagram"></a>`[NETF-05]` Layer 3 — the IP datagram
...
### <a id="netf-06-addressing--classes-private-ranges-and-cidr"></a>`[NETF-06]` Addressing — classes, private ranges, and CIDR

#### <a id="-address-classes-are-obsolete-learn-them-only-to-translate-other-peoples-speech"></a>🛑 Address classes are obsolete. Learn them only to translate other people's speech.
...
#### <a id="reserved-ranges-you-must-recognize-on-sight"></a>Reserved ranges you must recognize on sight
...
#### <a id="cidr--the-notation-that-replaced-classes"></a>CIDR — the notation that replaced classes
...
#### <a id="the-host-count-rule-stated-correctly"></a>The host-count rule, stated correctly
...
### <a id="netf-07-subnetting--a-procedure-you-can-execute-under-pressure"></a>`[NETF-07]` Subnetting — a procedure you can execute under pressure
...
#### <a id="step-by-step"></a>Step-by-step
...
#### <a id="-verify-with-powershell-instead-of-trusting-your-arithmetic"></a>✅ VERIFY with PowerShell instead of trusting your arithmetic
...
### <a id="netf-08-routing"></a>`[NETF-08]` Routing
...
#### <a id="the-routing-table"></a>The routing table
...
#### <a id="routing-protocols--the-vocabulary"></a>Routing protocols — the vocabulary
...
### <a id="netf-09-layer-4--ports-tcp-and-udp"></a>`[NETF-09]` Layer 4 — ports, TCP, and UDP

#### <a id="ports-and-multiplexing"></a>Ports and multiplexing
...
#### <a id="tcp-vs-udp--choose-by-failure-mode-not-by-speed"></a>TCP vs UDP — choose by failure mode, not by speed
...
#### <a id="the-three-way-handshake--tcp-connection-setup"></a>The three-way handshake — TCP connection setup
...
#### <a id="the-four-way-handshake--tcp-teardown"></a>The four-way handshake — TCP teardown
...
### <a id="netf-10-dns--resolution-servers-and-records"></a>`[NETF-10]` DNS — resolution, servers, and records
...
#### <a id="the-five-server-roles"></a>The five server roles
...
#### <a id="the-resolution-chain"></a>The resolution chain
...
#### <a id="record-types"></a>Record types
...
#### <a id="zones-and-delegation"></a>Zones and delegation
...
### <a id="netf-11-dhcp--automatic-addressing"></a>`[NETF-11]` DHCP — automatic addressing
...
#### <a id="dora--the-dhcp-transaction"></a>DORA — the DHCP transaction
...
#### <a id="allocation-types"></a>Allocation types
...
### <a id="netf-12-nat-port-forwarding-vpn-and-proxies"></a>`[NETF-12]` NAT, port forwarding, VPN, and proxies

#### <a id="nat--network-address-translation"></a>NAT — Network Address Translation
...
### <a id="netf-13-wireless"></a>`[NETF-13]` Wireless
...
#### <a id="80211-standards-current-as-of-august-2026--this-table-ages-protocol-facts-elsewhere-in-this-manual-do-not"></a>802.11 standards *(current as of August 2026 — this table ages; protocol facts elsewhere in this manual do not)*
...
#### <a id="wireless-security"></a>Wireless security
...
### <a id="netf-14-icmp-and-error-handling"></a>`[NETF-14]` ICMP and error handling
...
### <a id="netf-15-name-resolution-order-on-windows-and-the-hosts-file"></a>`[NETF-15]` Name resolution order on Windows, and the hosts file
...
### <a id="netf-16-ipv6-essentials"></a>`[NETF-16]` IPv6 essentials
...
### <a id="netf-17-http-https-and-status-codes"></a>`[NETF-17]` HTTP, HTTPS, and status codes
...
#### <a id="status-code-classes"></a>Status code classes
...
#### <a id="the-ones-you-will-actually-meet"></a>The ones you will actually meet
...
### <a id="netf-18-file-sharing-protocols"></a>`[NETF-18]` File sharing protocols
...
### <a id="netf-19-email-protocols"></a>`[NETF-19]` Email protocols
...
## <a id="23--security-fundamentals-secf"></a>23 — SECURITY FUNDAMENTALS `[SECF]`
...
### <a id="secf-01-malware-taxonomy--classify-by-propagation-and-purpose"></a>`[SECF-01]` Malware taxonomy — classify by propagation and purpose
...
### <a id="secf-02-attack-types"></a>`[SECF-02]` Attack types
...
### <a id="secf-03-social-engineering"></a>`[SECF-03]` Social engineering
...
### <a id="secf-04-cryptography--the-vocabulary-stated-precisely"></a>`[SECF-04]` Cryptography — the vocabulary, stated precisely
...
#### <a id="cipher-construction"></a>Cipher construction
...
#### <a id="symmetric-vs-asymmetric"></a>Symmetric vs asymmetric
...
### <a id="secf-05-hashing--and-the-claim-you-should-stop-repeating"></a>`[SECF-05]` Hashing — and the claim you should stop repeating
...
### <a id="secf-06-pki-and-certificates"></a>`[SECF-06]` PKI and certificates
...
### <a id="secf-07-hardware-backed-security"></a>`[SECF-07]` Hardware-backed security
...
### <a id="secf-08-aaa--authentication-authorization-accounting"></a>`[SECF-08]` AAA — authentication, authorization, accounting
...
### <a id="secf-09-radius-tacacs-and-kerberos--three-protocols-three-jobs"></a>`[SECF-09]` RADIUS, TACACS+, and Kerberos — three protocols, three jobs
...
### <a id="secf-10-kerberos--the-ticket-flow-and-why-ad-depends-on-it"></a>`[SECF-10]` Kerberos — the ticket flow, and why AD depends on it
...
#### <a id="-why-the-5-minute-clock-skew-limit-exists"></a>🛑 Why the 5-minute clock skew limit exists
...
### <a id="secf-11-8021x-and-eap--port-based-network-access-control"></a>`[SECF-11]` 802.1X and EAP — port-based network access control
...
### <a id="secf-12-sso-oauth-oidc-and-saml"></a>`[SECF-12]` SSO, OAuth, OIDC, and SAML
...
### <a id="secf-13-access-control"></a>`[SECF-13]` Access control
...
### <a id="secf-14-network-hardening"></a>`[SECF-14]` Network hardening
...
### <a id="secf-15-defense-in-depth-attack-vectors-and-attack-surface"></a>`[SECF-15]` Defense in depth, attack vectors, and attack surface
...
### <a id="secf-16-traffic-capture-and-intrusion-detection"></a>`[SECF-16]` Traffic capture and intrusion detection

#### <a id="capture-modes--three-different-things-with-similar-names"></a>Capture modes — three different things with similar names
...
#### <a id="ids-and-ips"></a>IDS and IPS
...
### <a id="secf-17-logging-and-correlation"></a>`[SECF-17]` Logging and correlation
...
## <a id="24--systems-and-directory-fundamentals-sysf"></a>24 — SYSTEMS AND DIRECTORY FUNDAMENTALS `[SYSF]`
...
### <a id="sysf-01-filesystem-concepts"></a>`[SYSF-01]` Filesystem concepts
...
### <a id="sysf-02-partition-tables--mbr-and-gpt"></a>`[SYSF-02]` Partition tables — MBR and GPT
...
### <a id="sysf-03-software-packaging-and-installation"></a>`[SYSF-03]` Software packaging and installation
...
### <a id="sysf-04-directory-services-and-ldap"></a>`[SYSF-04]` Directory services and LDAP
...
#### <a id="the-ldap-conversation"></a>The LDAP conversation
...
### <a id="sysf-05-windows-credential-stores"></a>`[SYSF-05]` Windows credential stores
...
### <a id="sysf-06-scaling-and-availability-concepts"></a>`[SYSF-06]` Scaling and availability concepts
...
## <a id="25--personal-additions"></a>25 — PERSONAL ADDITIONS
...
## <a id="26--microsoft-purview-and-data-governance-purv"></a>26 — MICROSOFT PURVIEW AND DATA GOVERNANCE `[PURV]`
...
### <a id="purv-01-the-solution-map--which-tool-answers-which-question"></a>`[PURV-01]` The solution map — which tool answers which question
...
### <a id="purv-02-data-classification--you-cannot-protect-what-you-have-not-identified"></a>`[PURV-02]` Data classification — you cannot protect what you have not identified
...
### <a id="purv-03-sensitivity-labels"></a>`[PURV-03]` Sensitivity labels
...
### <a id="purv-04-data-loss-prevention"></a>`[PURV-04]` Data Loss Prevention
...
#### <a id="dlp-deployment-procedure"></a>DLP deployment procedure
...
### <a id="purv-05-insider-risk-management"></a>`[PURV-05]` Insider Risk Management
...
### <a id="purv-06-communication-compliance"></a>`[PURV-06]` Communication Compliance
...
### <a id="purv-07-retention-data-lifecycle-management-and-the-four-principles"></a>`[PURV-07]` Retention, Data Lifecycle Management, and the four principles
...
#### <a id="-the-four-principles-of-retention--memorize-these"></a>🛑 The four principles of retention — memorize these
...
#### <a id="holds-are-not-retention"></a>Holds are not retention
...
### <a id="purv-08-ediscovery--the-unified-experience"></a>`[PURV-08]` eDiscovery — the unified experience
...
### <a id="purv-09-audit"></a>`[PURV-09]` Audit
...
### <a id="purv-10-compliance-manager"></a>`[PURV-10]` Compliance Manager
...
### <a id="purv-11-data-explorer-vs-activity-explorer"></a>`[PURV-11]` Data Explorer vs Activity Explorer
...
### <a id="purv-12-dspm-for-ai"></a>`[PURV-12]` DSPM for AI
...
### <a id="purv-13-purview-deployment-order"></a>`[PURV-13]` Purview deployment order
...
### <a id="purv-14-licensing-boundary--what-business-premium-actually-gets"></a>`[PURV-14]` Licensing boundary — what Business Premium actually gets
...
### <a id="purv-15-creating-a-label-is-not-publishing-it"></a>`[PURV-15]` Creating a label is not publishing it
...
### <a id="purv-16-dlp-policy-construction--the-confidence-dial"></a>`[PURV-16]` DLP policy construction — the confidence dial
...
### <a id="purv-17-simulation-mode-produces-the-full-appearance-of-enforcement"></a>`[PURV-17]` Simulation mode produces the full appearance of enforcement
...
### <a id="purv-18-encrypt-is-not-block"></a>`[PURV-18]` Encrypt is not Block
...
### <a id="purv-19-reporting-lag-notification-paths-and-what-is-already-running"></a>`[PURV-19]` Reporting lag, notification paths, and what is already running
...
## <a id="27--copilot-and-agent-administration-ai"></a>27 — COPILOT AND AGENT ADMINISTRATION `[AI]`
...
### <a id="ai-01-how-copilot-accesses-data"></a>`[AI-01]` How Copilot accesses data
...
#### <a id="microsoft-graph-the-semantic-index-and-work-iq"></a>Microsoft Graph, the semantic index, and Work IQ
...
### <a id="ai-02-the-control-stack-that-constrains-copilot"></a>`[AI-02]` The control stack that constrains Copilot
...
### <a id="ai-03-oversharing--what-it-is-and-why-ai-changed-the-stakes"></a>`[AI-03]` Oversharing — what it is and why AI changed the stakes
...
### <a id="ai-04-data-access-governance-reports"></a>`[AI-04]` Data Access Governance reports
...
### <a id="ai-05-sharepoint-advanced-management"></a>`[AI-05]` SharePoint Advanced Management
...
### <a id="ai-06-rac-vs-rcd-vs-restricted-sharepoint-search"></a>`[AI-06]` RAC vs RCD vs Restricted SharePoint Search
...
#### <a id="configuring-rcd"></a>Configuring RCD
...
#### <a id="restricted-sharepoint-search"></a>Restricted SharePoint Search
...
### <a id="ai-07-copilot-readiness-runbook"></a>`[AI-07]` Copilot readiness runbook
...
### <a id="ai-08-licensing--monthly-seat-vs-pay-as-you-go"></a>`[AI-08]` Licensing — monthly seat vs pay-as-you-go
...
### <a id="ai-09-assign-copilot-licenses"></a>`[AI-09]` Assign Copilot licenses
...
### <a id="ai-10-pay-as-you-go-billing-policies--the-two-step"></a>`[AI-10]` Pay-as-you-go billing policies — the two-step
...
### <a id="ai-11-monitoring-usage-and-adoption"></a>`[AI-11]` Monitoring usage and adoption

Two tiers of tooling, for two different audiences and two different questions.

#### <a id="tier-1--microsoft-365-admin-center-operational"></a>Tier 1 — Microsoft 365 admin center (operational)
...
#### <a id="tier-2--copilot-analytics-impact-and-business-value"></a>Tier 2 — Copilot Analytics (impact and business value)
...
### <a id="ai-12-prompt-management-and-governance"></a>`[AI-12]` Prompt management and governance
...
### <a id="ai-13-copilot-vs-agents-and-the-agent-taxonomy"></a>`[AI-13]` Copilot vs agents, and the agent taxonomy
...
### <a id="ai-14-configuring-user-access-to-agents"></a>`[AI-14]` Configuring user access to agents
...
### <a id="ai-15-creating-an-agent"></a>`[AI-15]` Creating an agent
...
### <a id="ai-16-the-agent-approval-process"></a>`[AI-16]` The agent approval process
...
### <a id="ai-17-monitoring-agents-and-the-lifecycle"></a>`[AI-17]` Monitoring agents and the lifecycle
...
### <a id="ai-18-agent-365-and-entra-agent-id"></a>`[AI-18]` Agent 365 and Entra Agent ID
...
### <a id="ai-19-which-copilot-features-can-be-enabled-or-disabled"></a>`[AI-19]` Which Copilot features can be enabled or disabled
...
### <a id="ai-20-copilot-and-agent-troubleshooting--symptom--cause--fix"></a>`[AI-20]` Copilot and agent troubleshooting — symptom → cause → fix
...
### <a id="ai-21-responsible-ai--the-principles-and-what-they-mean-operationally"></a>`[AI-21]` Responsible AI — the principles and what they mean operationally
...
## <a id="28--public-dns-for-mail-dns-mail"></a>28 — PUBLIC DNS FOR MAIL `[DNS-MAIL]`
...
### <a id="dns-mail-pre-pre-flight--before-you-touch-a-public-zone"></a>`[DNS-MAIL-PRE]` Pre-flight — before you touch a public zone
...
### <a id="dns-mail-00-the-record-set-and-what-each-one-actually-does"></a>`[DNS-MAIL-00]` The record set, and what each one actually does
...
### <a id="dns-mail-01-dns-record-inventory-script"></a>`[DNS-MAIL-01]` DNS record inventory script
...
### <a id="dns-mail-02-reading-the-results--nxdomain-vs-nodata-vs-wildcard"></a>`[DNS-MAIL-02]` Reading the results — NXDOMAIN vs NODATA vs wildcard
...
### <a id="dns-mail-03-registrar-delegation-vs-ns-records-in-the-zone"></a>`[DNS-MAIL-03]` Registrar delegation vs NS records in the zone
...
### <a id="dns-mail-04-dnssec--the-dssigning-mismatch"></a>`[DNS-MAIL-04]` DNSSEC — the DS/signing mismatch
...
### <a id="dns-mail-05-dkim--do-not-hand-build-the-cname-values"></a>`[DNS-MAIL-05]` DKIM — do not hand-build the CNAME values
...
### <a id="dns-mail-06-spf--the-rules-that-actually-bite"></a>`[DNS-MAIL-06]` SPF — the rules that actually bite
...
### <a id="dns-mail-07-dmarc--deployment-template-and-client-tuning"></a>`[DNS-MAIL-07]` DMARC — deployment template and client tuning
...
### <a id="dns-mail-08-bounce-codes-and-the-implicit-mx-fallback"></a>`[DNS-MAIL-08]` Bounce codes and the implicit MX fallback
...
## <a id="29--exchange-online-administration-exo"></a>29 — EXCHANGE ONLINE ADMINISTRATION `[EXO]`
...
### <a id="exo-00-connecting-to-exchange-online-powershell--the-parts-that-go-wrong"></a>`[EXO-00]` Connecting to Exchange Online PowerShell — the parts that go wrong
...
### <a id="exo-01-message-trace--what-it-is-and-its-hard-boundary"></a>`[EXO-01]` Message trace — what it is, and its hard boundary
...
### <a id="exo-02-message-trace--status-values"></a>`[EXO-02]` Message trace — status values
...
### <a id="exo-03-message-trace--event-types-and-what-they-prove"></a>`[EXO-03]` Message trace — event types and what they prove
...
### <a id="exo-04-message-trace--message-id-vs-messagetrace-id"></a>`[EXO-04]` Message trace — Message-ID vs MessageTrace ID
...
### <a id="exo-05-message-trace--time-zone-rendering-trap"></a>`[EXO-05]` Message trace — time zone rendering trap
...
### <a id="exo-06-anti-spam-and-quarantine--two-policy-objects-not-one"></a>`[EXO-06]` Anti-spam and quarantine — two policy objects, not one
...
### <a id="exo-07-testing-spam-filtering-and-the-allow-list-anti-pattern"></a>`[EXO-07]` Testing spam filtering, and the allow-list anti-pattern
...
### <a id="exo-08-shared-mailboxes"></a>`[EXO-08]` Shared mailboxes
...
### <a id="exo-09-delegation-and-attribution--what-message-trace-can-and-cannot-tell-you"></a>`[EXO-09]` Delegation and attribution — what message trace can and cannot tell you
...
### <a id="exo-10-mail-enabled-groups--the-operational-consequences"></a>`[EXO-10]` Mail-enabled groups — the operational consequences
...
### <a id="exo-11-universal-scope-requirement--and-what-it-means-for-agdlp"></a>`[EXO-11]` Universal scope requirement — and what it means for AGDLP
...
### <a id="exo-12-synced-objects-are-read-only-in-the-cloud-exo-proxy"></a>`[EXO-12]` Synced objects are read-only in the cloud `[EXO-PROXY]`
...
### <a id="exo-13-proxyaddresses--aliases-and-changing-the-primary-smtp"></a>`[EXO-13]` proxyAddresses — aliases and changing the primary SMTP
...
### <a id="exo-14-upn-is-not-primary-smtp"></a>`[EXO-14]` UPN is not primary SMTP
...
### <a id="spo-01-external-sharing--three-layers-most-restrictive-wins"></a>`[SPO-01]` External sharing — three layers, most restrictive wins
...
### <a id="spo-02-anyone-link-vs-specific-person-share--different-mechanisms"></a>`[SPO-02]` Anyone link vs specific-person share — different mechanisms
...
### <a id="spo-03-guest-objects--recognizing-and-auditing-them"></a>`[SPO-03]` Guest objects — recognizing and auditing them
...
### <a id="spo-04-permission-inheritance--the-part-people-miss"></a>`[SPO-04]` Permission inheritance — the part people miss
...
### <a id="spo-05-sharing-notification-emails-are-not-in-message-trace"></a>`[SPO-05]` Sharing notification emails are not in message trace
...
### <a id="spo-06-the-people-picker-trap"></a>`[SPO-06]` The people picker trap
...
### <a id="spo-07-break-glass-account-naming"></a>`[SPO-07]` Break-glass account naming
...
### <a id="spo-08-roles-required-and-the-business-premium-reality"></a>`[SPO-08]` Roles required, and the Business Premium reality
